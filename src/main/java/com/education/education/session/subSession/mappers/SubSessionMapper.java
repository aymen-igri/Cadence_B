...
public class SubSessionMapper {
  ...
  public StackedAreaChartData toStackedAreaChartData(
      SubSession subSessions) {
    return new StackedAreaChartData(
        subSessions.getDayOfWeek(),
        subSessions.getStartTime());
  }

  public StackedAreaChart toStackedAreaChart(
